...
public class AddKQActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_over).setVisibility(View.GONE);//设置控件隐藏
        findViewById(R.id.btn_stusubmit).setVisibility(View.GONE);//设置控件隐藏
        initView();
        setToolbar("签到");
    }
    ...
    private void submit() {
        ...
        HttpUtil httpUtil = new HttpUtil(getApplicationContext(), "AddQD") {
            @Override
