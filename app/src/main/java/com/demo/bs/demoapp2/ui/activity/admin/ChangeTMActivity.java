...
public class ChangeTMActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        tm =getIntent().getParcelableExtra("info");
        edt_a1.setText(tm.getA1());
        edt_a2.setText(tm.getA2());
        edt_a3.setText(tm.getA3());
        edt_a4.setText(tm.getA4());
        edt_da.setText(tm.getDa());
        edt_wt.setText(tm.getWt());
        setToolbar("修改题目");
        infos = new ArrayList<>();
    ...
    String zsd = edt_zsd.getText().toString().trim();
        ...
        HttpUtil httpUtil = new HttpUtil(getApplicationContext(), "UpdateTM") {
            @Override
        ...
        httpUtil.addParams("id",tm.getId());
