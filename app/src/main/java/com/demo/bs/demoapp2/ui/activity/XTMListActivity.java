...
import com.demo.bs.demoapp2.ui.activity.admin.ChangeTMActivity;
...
public class XTMListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   btn_delete = (Button) findViewById(R.id.btn_delete);
       ...
       // findViewById(R.id.btn_add).setVisibility(View.GONE);
         final String[] strings ={"修改","删除该题"};
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                new AlertDialog.Builder(XTMListActivity.this).setItems(strings, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which){
                            case 0:
                                ...
                                Intent intent =new Intent(XTMListActivity.this,ChangeTMActivity.class);
                                intent.putExtras(b);
...
//                Bundle b =new Bundle();
//                b.putParcelable("info",infos.get(position));
//                Intent intent =new Intent(XTMListActivity.this,ZYActivity.class);
//                intent.putExtras(b);
//                startActivityForResult(intent,1);
            }
        });
    ...
    private void del(String id) {
        HttpUtil httpUtil = new HttpUtil(getApplicationContext(), "DelZY") {
            @Override
            protected void onCallback(String json) {
                showToast("删除成功");
                getData();
